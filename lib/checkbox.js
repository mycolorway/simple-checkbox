...
Checkbox = (function(_super) {
  ...
  Checkbox.prototype._render = function() {
    ...
    if (!this.opts.animation) {
      this.el.find('.checkbox-ripple').remove();
    }
  ...
  Checkbox.prototype._startAnimate = function() {
    if (this.el.hasClass('animation-start animation-checked-start animation-end')) {
      return;
    }
    if (this.checked) {
      this.el.addClass('animation-start');
    } else {
      this.el.addClass('animation-checked-start');
    }
    return this.el.find('.checkbox-ripple').one('transitionend', (function(_this) {
      return function() {
  ...
  Checkbox.prototype._endAnimate = function() {
    ...
    return setTimeout((function(_this) {
      return function() {
        return _this.el.find('.checkbox-ripple').one('transitionend', function() {
          return _this.el.removeClass('animation-start animation-end animation-checked-start');
        });
      };
    })(this), 0);
  };
