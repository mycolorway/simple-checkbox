...
Checkbox = (function(_super) {
  ...
  Checkbox.prototype._render = function() {
    ...
    if (this.el.length < 1) {
      ...
      this.el.find('.checkbox-tick').css({
        'border-right': 0.15 * this.opts.size + 'px solid',
        'border-bottom': 0.15 * this.opts.size + 'px solid'
      });
    }
  ...
  Checkbox.prototype._startAnimate = function() {
    ...
    return this.el.find('.checkbox-ripple').one('animationend webkitAnimationEnd oAnimationEnd', (function(_this) {
      return function() {
