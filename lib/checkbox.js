...
Checkbox = (function(_super) {
  ...
  Checkbox.prototype._animationTpl = '<div class="checkbox-ripple"></div>';
  ...
  Checkbox.prototype._render = function() {
    ...
    if (this.opts.animation) {
      $(this._animationTpl).insertAfter(this.el.find('.checkbox-tick'));
    }
  ...
  Checkbox.prototype._endAnimate = function() {
    ...
    return setTimeout((function(_this) {
      return function() {
        return _this.el.one('transitionend', function() {
