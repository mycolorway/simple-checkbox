...
Checkbox = (function(_super) {
  ...
  Checkbox.prototype._startAnimate = function() {
    ...
    this.el.addClass('animation-start animation-switch');
    return this.ripple.one(SimpleUtil.transitionEnd(), (function(_this) {
      return function(e) {
  ...
  Checkbox.prototype._endAnimate = function() {
    var reflow;
    this.el.removeClass('animation-switch');
    reflow = this.el[0].offsetHeight;
    this.el.addClass('animation-switch animation-end');
    return this.ripple.one(SimpleUtil.transitionEnd(), (function(_this) {
      return function(e) {
